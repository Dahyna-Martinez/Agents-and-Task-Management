...
from search import simulated_annealing, EightPuzzle # Imported Simulated Annealing
...
def solve():
    """Solves the puzzle simulated annealing"""    

    return simulated_annealing(puzzle).solution()
